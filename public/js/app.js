...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    cCategories: function cCategories() {
  ...
  methods: {
    getCategories: function getCategories() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(Object(_route__WEBPACK_IMPORTED_MODULE_1__["default"])("categories.index") + '?hierarchy=1').then(function (response) {
    ...
    getProducts: function getProducts(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(Object(_route__WEBPACK_IMPORTED_MODULE_1__["default"])("categories.index") + '/' + id).then(function (response) {
  ...
  watch: {
    categories: function categories(newValue) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getLog: function getLog(message) {
      console.log(message);
    }
  }
});
        ...
        _c("div", { staticClass: "column is-two-fifths" }, [
          _c("aside", { staticClass: "menu" }, [
            ...
            _c(
              ...
              _vm._l(_vm.categories, function(model) {
                return _vm.categories
                  ? _c("tree", {
                      staticClass: "item",
                      attrs: { model: model, active: _vm.active },
                      on: {
                ...
                return _vm.products
                  ? _c("tr", [
                      ...
                      _c("td", [
                        _c(
                          "a",
                          { attrs: { target: "_blank", href: product.img } },
                          [_vm._v("Open image")]
                        )
                      ])
                    ])
  ...
  return _c("li", [
    _c("div", [
      _c(
        "a",
        {
          class: { "is-active": _vm.active === _vm.model.id },
          on: {
            click: function($event) {
              return _vm.getProducts(_vm.model.id)
            }
          }
        },
        [
      ...
      ? _c(
          ...
          _vm._l(_vm.model.children, function(model) {
            return _c("tree", {
              staticClass: "item",
              attrs: { model: model, active: _vm.active },
              on: { getProducts: _vm.getProducts }
            })
          }),
          1
        )
...
/*!**********************************!*\
  !*** ./resources/js/routes.json ***!
  \**********************************/
/*! exports provided: products.index, products.store, products.show, products.update, products.destroy, categories.index, categories.store, categories.show, categories.update, categories.destroy, home, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"products.index\":\"api/v0/products\",\"products.store\":\"api/v0/products\",\"products.show\":\"api/v0/products/{product}\",\"products.update\":\"api/v0/products/{product}\",\"products.destroy\":\"api/v0/products/{product}\",\"categories.index\":\"api/v0/categories\",\"categories.store\":\"api/v0/categories\",\"categories.show\":\"api/v0/categories/{category}\",\"categories.update\":\"api/v0/categories/{category}\",\"categories.destroy\":\"api/v0/categories/{category}\",\"home\":\"/\"}");
...
__webpack_require__(/*! C:\Users\feny8\PhpstormProjects\mesh_group\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\feny8\PhpstormProjects\mesh_group\resources\sass\app.scss */"./resources/sass/app.scss");
